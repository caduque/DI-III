...
public class clsLlamadas {
    ...
    public clsProposito getObclsProposito() {
        return obclsProposito;
    }

    public void setObclsProposito(clsProposito obclsProposito) {
        this.obclsProposito = obclsProposito;
    }
    ...
    public clsProposito obclsProposito;
